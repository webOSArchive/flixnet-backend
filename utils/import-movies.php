...
//Determine config
echo "Resume:   <input type='text' name='resume' value='" . htmlspecialchars($resume, ENT_QUOTES) . "' " . $rd .">" . eol();
...
echo "Max/Pass:  <input type='text' name='max' value='" . htmlspecialchars($max, ENT_QUOTES) . "' " . $md .">" . eol();
...
echo "Cooldown: <input type='text' name='cooldown' value='" . htmlspecialchars($cooldown, ENT_QUOTES) . "' " . $dd .">" . eol();
